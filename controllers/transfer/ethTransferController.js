...
const TransferETH = require("../../helpers/ethTransfer");
...
class bnbTransferController {
    static sendETH(req, res, next) {
        ...
        Account.findOne({ user })
            .then(async function (account) {
                ...
                return TransferETH(toAddress, myValue, newKey);
            })
            .then(function (trx) {
                console.log("ini", trx);
                return ethHistory
    ...
    static async sendAdminETH(req, res, next) {
        console.log(
        ...
        Account.findOne({ role: "admin" })
            .then(async function (account) {
                ...
                return TransferETH(toAddress, adminValue, key);
            })
            .then(function (trxid) {
