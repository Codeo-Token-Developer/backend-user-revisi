...
const { readAllLimit, 
    ...
    readMyLimit, createLimitBuy, createLimitSell, readAllHistory, readMyHistory, createBuyMarketHistory } = require('../../controllers/exchange/tradeController');
const { userAuthentication } = require('../../middlewares/Auth');

Router.get('/trade/limit/:coin', readAllLimit);
Router.get('/trade/myLimit/:coin', userAuthentication, readMyLimit);
Router.post('/trade/limit/buy', userAuthentication, createLimitBuy)
